...
namespace Session.Data.Data
{
    public partial class ToyUniverseContext : DbContext
    {
        ...
        //    {
        //        optionsBuilder.UseSqlServer("Server=JLMBQG3;Database=ToyUniverse;User Id=sa;Password=sqlmalambing");
        //    }
        //}
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.CShippingMode)
                    ...
                    .HasConstraintName("FK__Orders__cShippin__4F7CD00D");

                entity.HasOne(d => d.CShopper)
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.CShopperId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Orders__cShopper__4E88ABD4");
            });
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.COrderNoNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__OrderDeta__cOrde__52593CB8");

                entity.HasOne(d => d.CToy)
                    .WithMany(p => p.OrderDetails)
                    .HasForeignKey(d => d.CToyId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__OrderDeta__cToyI__534D60F1");

                entity.HasOne(d => d.CWrapper)
                    .WithMany(p => p.OrderDetails)
                    .HasForeignKey(d => d.CWrapperId)
                    .HasConstraintName("FK__OrderDeta__cWrap__5441852A");
            });
            ...
            modelBuilder.Entity<PickOfMonth>(entity =>
            {
                ...
                entity.HasOne(d => d.CToy)
                    ...
                    .HasForeignKey(d => d.CToyId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PickOfMon__cToyI__5EBF139D");
            });
            ...
            modelBuilder.Entity<Recipient>(entity =>
            {
                ...
                entity.HasOne(d => d.CCountry)
                    ...
                    .HasConstraintName("FK__Recipient__cCoun__5AEE82B9");

                entity.HasOne(d => d.COrderNoNavigation)
                    .WithOne(p => p.Recipient)
                    .HasForeignKey<Recipient>(d => d.COrderNo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Recipient__cOrde__59FA5E80");
            });
            ...
            modelBuilder.Entity<Shipment>(entity =>
            {
                ...
                entity.HasOne(d => d.COrderNoNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Shipment__cOrder__571DF1D5");
            });
            ...
            modelBuilder.Entity<ShippingRate>(entity =>
            {
                ...
                entity.HasOne(d => d.CCountry)
                    ...
                    .HasForeignKey(d => d.CCountryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ShippingR__cCoun__403A8C7D");

                entity.HasOne(d => d.CMode)
                    .WithMany(p => p.ShippingRates)
                    .HasForeignKey(d => d.CModeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ShippingR__cMode__412EB0B6");
            });
            ...
            modelBuilder.Entity<Shopper>(entity =>
            {
                ...
                entity.HasOne(d => d.CCountry)
                    ...
                    .HasForeignKey(d => d.CCountryId)
                    .HasConstraintName("FK__Shopper__cCountr__440B1D61");
            });
            ...
            modelBuilder.Entity<ShoppingCart>(entity =>
            {
                ...
                entity.HasOne(d => d.CToy)
                    ...
                    .HasForeignKey(d => d.CToyId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ShoppingC__cToyI__4BAC3F29");
            });
            ...
            modelBuilder.Entity<Toy>(entity =>
            {
                ...
                entity.HasOne(d => d.CBrand)
                    ...
                    .HasConstraintName("FK__Toys__cBrandId__48CFD27E");

                entity.HasOne(d => d.CCategory)
                    .WithMany(p => p.Toys)
                    .HasForeignKey(d => d.CCategoryId)
                    .HasConstraintName("FK__Toys__cCategoryI__47DBAE45");
            });
